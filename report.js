...
exports.handler = async (object, db) => {
  ...
  if (file.match(/\.[0-9a-z]+$/i)[0] === '.json')
  {
    try{
      ...
      loadToBQ(categoriesCount,"contextual_categories_counts")
      loadToBQ(categoriesUrls,"contextual_categories_urls")
      loadToBQ(categoriesMetrics,"contextual_categories_metrics")
      loadToBQ(segmentCounts,"segments_counts")
      loadToBQ(segmentMetrics,"segments_metrics")
